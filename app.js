...
let wordList = [
/*    [1, `der Abend`, `晩`, 1, `Abends ／ Abende`, ``, 0, null, null],
    [2, `das Abendessen`, `夕食`, 1, `Abendessens ／ Abendessen`, ``, 2, null, null],
    [3, `abends`, `晩に`, 3, ``, ``, 2, null, null],
    [4, `aber`, `しかし`, 6, ``, `並列接続詞`, 0, null, null],
    ...
    [43, `der Anzug`, `スーツ`, 1, `Anzugs / -es ／ Anzüge`, ``, 3, null, null],
    [44, `die Arbeit`, `仕事`, 1, `Arbeit ／ Arbeiten`, ``, 0, null, null],
    [45, `arbeiten`, `働く`, 2, ``, ``, 0, null, null],
    ...
    [51, `der Arzt`, `医者`, 1, `Arztes ／ Ärzte`, ``, 0, null, null],
    ...
    [63, `aus`, `…の中から／…から`, 5, ``, `３格支配`, 0, null, null],
    ...
    [75, `das Auto`, `自動車`, 1, `Autos ／ Autos`, ``, 0, null, null],
    [76, `das Baby`, `赤ん坊`, 1, `Babys ／ Babys`, ``, 2, null, null],
    ...
    [81, `der Bahnhof`, `駅`, 1, `Bahnhofs ／ Bahnhöfe`, ``, 0, null, null],
    [82, `bald`, `まもなく`, 3, `eher ／ am ehesten`, ``, 0, null, null],
    [83, `die Bank`, `ベンチ`, 1, `Bank ／ Bänke`, ``, 0, null, null],
    ...
    [95, `beginnen`, `始まる`, 2, `begann ／ begonnen`, ``, 0, null, null],
    ...
    [111, `das Berlin`, `ベルリン`, 1, ``, ``, 1, null, null],
    [112, `der Berliner`, `ベルリンの人`, 1, `Berliners ／ Berliner`, ``, 2, null, null],
    ...
    [124, `der Besuch`, `訪問`, 1, `Besuchs ／ Besuche`, ``, 1, null, null],
    [125, `besuchen`, `訪問する`, 2, ``, ``, 0, null, null],
    ...
    [145, `das Bonn`, `ボン`, 1, ``, ``, 3, null, null],
    [146, `der Brand`, `火事`, 1, `Brands / -es ／ Brände`, ``, 4, null, null],
    [147, `das Brasilien`, `ブラジル`, 1, ``, ``, 4, null, null],
    [148, `brauchen`, `必要とする`, 2, ``, ``, 0, null, null],
    [149, `braun`, `褐色の`, 4, ``, ``, 2, null, null],
    [150, `brechen`, `折る`, 2, `bricht ／ brach ／ gebrochen`, ``, 3, null, null],
    [151, `das Brett`, `板`, 1, `Bretts / -es ／ Bretter`, ``, 4, null, null],
    [152, `der Brief`, `手紙`, 1, `Briefes ／ Briefe`, ``, 1, null, null],
    [153, `die Brille`, `眼鏡`, 1, `Brille ／ Brillen`, ``, 3, null, null],
    [154, `bringen`, `持っていく`, 2, `brachte ／ gebracht`, ``, 0, null, null],
    [155, `das Brötchen`, `ブレートヒェン`, 1, `Brötchens ／ Brötchen`, ``, 3, null, null],
    [156, `der Bruder`, `兄弟`, 1, `Bruder s ／ Brüder ü`, ``, 1, null, null],
    [157, `das Buch`, `本`, 1, `Buches ／ Bücher`, ``, 0, null, null],
    [158, `das Büro`, `オフィス`, 1, `Büros ／ Büros`, ``, 1, null, null],
    [159, `der Bus`, `バス`, 1, `Buses ／ Buse`, ``, 1, null, null],
    [160, `das Café`, `喫茶店`, 1, `Cafés ／ Cafés`, ``, 0, null, null],
    [161, `der Chef`, `長`, 1, `Chefs ／ Chef`, ``, 1, null, null],
    [162, `die Chefin`, `長`, 1, `Chefin ／ Chefinnen`, ``, 1, null, null],
    [163, `das Chinesisch`, `中国語`, 1, `Chinesischs ／ -`, ``, 2, null, null],
    [164, `der Clown`, `道化師`, 1, `Clowns ／ Clowns`, ``, 5, null, null],
    [165, `der Comic`, `漫画`, 1, `Comics ／ Comic`, ``, 5, null, null],
    [166, `der Computer`, `コンピュータ`, 1, `Computers ／ Computer`, ``, 0, null, null],
    [167, `da`, `…だから`, 6, ``, `従属接続詞`, 0, null, null],
    [168, `dabei`, `そのそばに`, 3, ``, ``, 0, null, null],
    [169, `das Dach`, `屋根`, 1, `Dachs / -es ／ Dächer`, ``, 1, null, null],
    ...
    [191, `das Deutsch`, `ドイツ語`, 1, `Deutsch / -s ／ -`, ``, 0, null, null],
    [192, `deutsch`, `ドイツの`, 4, ``, ``, 0, null, null],
    [193, `das Deutschland`, `ドイツ`, 1, ``, ``, 0, null, null],
    [194, `der Deutschlehrer`, `ドイツ語教師`, 1, `Deutschlehrers ／ Deutschlehrer`, ``, 5, null, null],
    ...
    [199, `das Ding`, `物`, 1, `Dings ／ Dinge`, ``, 0, null, null],
    ...
    [213, `der Durst`, `喉の渇き`, 1, `Durstes ／ -`, ``, 3, null, null],
    [214, `das Düsseldorf`, `デュッセルドルフ`, 1, ``, ``, 3, null, null],
    [215, `die E-Mail`, `電子メール`, 1, `E-Mail ／ E-Mails`, ``, 2, null, null],
    ...
    [231, `empfehlen`, `勧める`, 2, `empfiehlt ／ empfahl ／ empfohlen`, ``, 0, null, null],
    [232, `empören`, `憤慨させる`, 2, ``, ``, 5, null, null],
    [233, `das Ende`, `終わり`, 1, `Endes ／ Enden`, ``, 0, null, null],
    [234, `endlich`, `やっと`, 3, ``, ``, 1, null, null],
    [235, `das Englisch`, `英語`, 1, `Englisch ／ -`, ``, 1, null, null],
    ...
    [252, `erkälten`, `風邪をひく`, 2, ``, `再`, 3, null, null],
    ...
    [270, `das Essen`, `食事`, 1, `Essens ／ Essen`, ``, 0, null, null],
    [271, `essen`, `食べる`, 2, `isst ／ aß ／ gegessen`, ``, 0, null, null],
    [272, `etwa`, `約`, 3, ``, ``, 0, null, null],
    [273, `das Europa`, `ヨーロッパ`, 1, ``, ``, 0, null, null],
    [274, `das Examen`, `試験`, 1, `Examens ／ Examen`, ``, 5, null, null],
    ...
    [284, `fangen`, `捉える`, 2, `fängt ／ fing ／ gefangen`, ``, 3, null, null],
    ...
    [313, `folgen`, `あとについて行く`, 2, ``, ``, 1, null, null],
    [314, `das Formular`, `書き込み用紙`, 1, `Formulars ／ Formulare`, ``, 2, null, null],
    [315, `das Foto`, `写真`, 1, `Fotos ／ Fotos`, ``, 1, null, null],
    [316, `fotografieren`, `写真を撮る`, 2, ``, ``, 3, null, null],
    [317, `die Frage`, `問い`, 1, `Frage ／ Fragen`, ``, 0, null, null],
    [318, `fragen`, `尋ねる`, 2, ``, ``, 0, null, null],
    ...
    [323, `die Frau`, `女性、妻、夫人`, 1, `Frau ／ Frauen`, ``, 0, null, null],
    [324, `frei`, `自由な`, 4, ``, ``, 0, null, null],
    ...
    [341, `der Füller`, `万年筆`, 1, `Füllers ／ Füller`, ``, 5, null, null],
    ...
    [351, `geben`, `渡す`, 2, `gibt ／ gab ／ gegeben`, ``, 0, null, null],
    [352, `das Gedächtnis`, `記憶力`, 1, `Gedächtnisses ／ Gedächtnisse`, ``, 4, null, null],
    [353, `gedenken`, `思い出す`, 2, `→ denken`, ``, 5, null, null],
    ...
    [359, `gehen`, `行く`, 2, `ging ／ gegangen`, ``, 0, null, null],
    [360, `gehören`, `〜のものである`, 2, ``, ``, 0, null, null],
    ...
    [365, `das Geld`, `お金`, 1, `Geldes ／ Gelder`, ``, 0, null, null],
    ...
    [375, `gern`, `喜んで`, 3, `lieber ／ am liebsten`, ``, 0, null, null],
    ...
    [379, `die Geschichte`, `歴史`, 1, `Geschichte ／ Geschichten`, ``, 0, null, null],
    ...
    [383, `gestern`, `昨日`, 3, ``, ``, 0, null, null],
    */
    [384, `gesund`, `健康な`, 4, ``, ``, 1, null, null],
    /*
    [385, `die Gesundheit`, `健康`, 1, `Gesundheit ／ -`, ``, 1, null, null],
    [386, `der Gewinn`, `利益`, 1, `Gewinns ／ Gewinne`, ``, 2, null, null],
    [387, `der Gipfel`, `山頂`, 1, `Gipfels ／ Gipfel`, ``, 4, null, null],
    [388, `das Glas`, `ガラス`, 1, `Glases ／ Gläser`, ``, 2, null, null],
    [389, `glauben`, `思う`, 2, ``, ``, 0, null, null],
    */
    [390, `gleich`, `すぐに`, 4, ``, `※`, 0, null, null],
    /*
    [391, `gleichen`, `似ている`, 2, `glich ／ geglichen`, ``, 5, null, null],
    [392, `das Glück`, `幸運`, 1, `Glücks ／ -`, ``, 1, null, null],
    [393, `glücklich`, `幸福な`, 4, ``, ``, 1, null, null],
    [394, `das Gold`, `金`, 1, `Golds / -es ／ -`, ``, 3, null, null],
    [395, `der Gott`, `神`, 1, `Gottes ／ Götter`, ``, 1, null, null],
    [396, `grade`, `今`, 3, ``, ``, 5, null, null],
    [397, `greifen`, `手を伸ばす`, 2, `griff ／ gegriffen`, ``, 3, null, null],
    [398, `groß`, `大きい`, 4, ``, ``, 0, null, null],
    [399, `die* Großeltern`, `祖父母`, 1, `- ／ Großeltern`, ``, 2, null, null],
    [400, `die Großmutter`, `祖母`, 1, `Großmutter ／ Großmutterer`, ``, 2, null, null],
    [401, `der Großvater`, `祖父`, 1, `Großvaters ／ Großväter`, ``, 2, null, null],
    [402, `grün`, `緑色の`, 4, ``, ``, 0, null, null],
    ...
    [421, `das Haus`, `家`, 1, `Hauses ／ Häuser`, ``, 0, null, null],
    [422, `die Hausaufgabe`, `宿題`, 1, `Hausaufgabe ／ Hausaufgaben`, ``, 2, null, null],
    ...
    */
    ...
    [455, `das Hotel`, `ホテル`, 1, `Hotels ／ Hotels`, ``, 0, null, null],
    [456, `hübsch`, `きれいな`, 4, ``, ``, 2, null, null],
    [457, `der Hubschrauber`, `ヘリコプター`, 1, `Hubschraubers ／ Hubschrauber`, ``, 5, null, null],
    [458, `der Hund`, `犬`, 1, `Hundes ／ Hunde`, ``, 1, null, null],
    [459, `der Hunger`, `空腹`, 1, `Hungers ／ -`, ``, 2, null, null],
    [460, `der Hut`, `帽子`, 1, `Hutes ／ Hüte`, ``, 4, null, null],
    [461, `immer`, `いつも、ますます`, 3, ``, ``, 0, null, null],
    ...
    [476, `ja`, `はい`, 3, ``, ``, 0, null, null],
    [477, `die Jacke`, `上着`, 1, `Jacke ／ Jackeen`, ``, 2, null, null],
    [478, `das Jahr`, `年`, 1, `Jahres ／ Jahre`, ``, 0, null, null],
    [479, `das Jahrhundert`, `世紀`, 1, `Jahrhunderts ／ Jahrhunderte`, ``, 1, null, null],
    [480, `das Japan`, `日本`, 1, ``, ``, 0, null, null],
    [481, `das Japanisch`, `日本語`, 1, `Japanischs ／ -`, ``, 0, null, null],
    [482, `japanisch`, `日本の`, 4, ``, ``, 0, null, null],
    [483, `das Japanische`, `日本語`, 1, ``, ``, 5, null, null],
    [484, `je`, `かつて`, 3, ``, ``, 0, null, null],
    [485, `jetzt`, `今`, 3, ``, ``, 0, null, null],
    [486, `jung`, `若い`, 4, ``, ``, 0, null, null],
    [487, `der Junge`, `男の子`, 1, `Jungen ／ Jungen`, ``, 0, null, null],
    [488, `die* Jura`, `法学`, 1, `- ／ Jura`, ``, 5, null, null],
    [489, `der Kaffee`, `コーヒー`, 1, `Kaffees ／ Kaffees`, ``, 0, null, null],
    ...
    [498, `die Katze`, `猫`, 1, `Katze ／ Katzen`, ``, 2, null, null],
    [499, `kaufen`, `買う`, 2, ``, ``, 0, null, null],
    ...
    [505, `das Kind`, `子供`, 1, `Kindes ／ Kinder`, ``, 0, null, null],
    [506, `das Kino`, `映画館`, 1, `Kinos ／ Kinos`, ``, 1, null, null],
    [507, `die Kirche`, `教会`, 1, `Kirche ／ Kirchen`, ``, 0, null, null],
    [508, `die Klasse`, `クラス`, 1, `Klasse ／ Klassen`, ``, 0, null, null],
    ...
    [523, `kommen`, `行く`, 2, `kam ／ gekommen`, ``, 0, null, null],
    ...
    [531, `krank`, `病気の`, 4, ``, ``, 1, null, null],
    [532, `das Krankenhaus`, `病院`, 1, `Krankenhauses ／ Krankenhäuser`, ``, 2, null, null],
    ...
    [552, `lassen`, `〜させる（助動詞）`, 2, `lässt ／ ließ ／ lassen / gelassen`, ``, 0, null, null],
    [553, `laufen`, `走る`, 2, `läuft ／ lief ／ gelaufen`, ``, 0, null, null],
    [554, `laufen`, `走る`, 2, `läuft ／ lief ／ gelaufen`, ``, 0, null, null],
    ...
    [566, `der Lehrer`, `教師`, 1, `Lehrers ／ Lehrer`, ``, 0, null, null],
    [567, `die Lehrerin`, `女性の教師`, 1, `Lehrerin ／ Lehrerinnen`, ``, 0, null, null],
    ...
    */
    [572, `leider`, `残念ながら`, 3, ``, ``, 0, null, null],
    /*
    [573, `leihen`, `貸す、借りる`, 2, `lieh ／ geliehen`, ``, 2, null, null],
    [574, `das Leipzig`, `ライプツィヒ`, 1, ``, ``, 3, null, null],
    [575, `leise`, `小さい`, 4, ``, ``, 2, null, null],
    [576, `leiten`, `率いる`, 2, ``, ``, 2, null, null],
    [577, `lernen`, `学ぶ`, 2, ``, ``, 0, null, null],
    [578, `lesen`, `読む`, 2, `liest ／ las ／ gelesen`, ``, 0, null, null],
    [579, `letzt`, `最後の`, 4, `letzter ／ -`, ``, 5, null, null],
    [580, `die* Leute`, `人々`, 1, `- ／ Leute`, ``, 0, null, null],
    [581, `lieben`, `愛する`, 2, ``, ``, 1, null, null],
    ...
    [591, `die Luft`, `空気`, 1, `Luft ／ Lufte`, ``, 1, null, null],
    ...
    [597, `machen`, `作る`, 2, ``, ``, 0, null, null],
    [598, `das Mädchen`, `女の子`, 1, `Mädchens ／ Mädchen`, ``, 0, null, null],
    [599, `der Mai`, `５月`, 1, `Mai ／ Maie`, ``, 0, null, null],
    [600, `mal`, `掛ける`, 3, ``, ``, 0, null, null],
    [601, `manchmal`, `時々`, 3, ``, ``, 1, null, null],
    [602, `der Mann`, `男`, 1, `Mannes ／ Männer`, ``, 0, null, null],
    ...
    [625, `der Mittag`, `昼`, 1, `Mittags ／ Mittage`, ``, 1, null, null],
    [626, `der Mittagsschlaf`, `昼寝`, 1, `Mittagsschlafs / -es ／ -`, ``, 5, null, null],
    [627, `die Mitte`, `中央`, 1, `Mitte ／ Mitten`, ``, 0, null, null],
    ...
    [635, `der Morgen`, `朝`, 1, `Morgens ／ Morgen`, ``, 0, null, null],
    [636, `der Müller`, `粉屋`, 1, `Müllers ／ Müller`, ``, 5, null, null],
    [637, `das München`, `ミュンヘン`, 1, ``, ``, 1, null, null],
    ...
    [642, `die Mutter`, `母`, 1, `Mutter ／ Mütterer`, ``, 0, null, null],
    ...
    [648, `die Nacht`, `夜`, 1, `Nacht ／ Nächte`, ``, 0, null, null],
    [649, `nahe`, `近い`, 4, ``, ``, 2, null, null],
    [650, `die Nähe`, `近く`, 1, `Nähe ／ -`, ``, 1, null, null],
    [651, `der Name`, `名前`, 1, `Namens ／ Namen`, ``, 0, null, null],
    [652, `neben`, `…の傍らで／に／へ`, 5, ``, `３・４格支配`, 0, null, null],
    [653, `nebenan`, `隣に`, 3, ``, ``, 4, null, null],
    [654, `nehmen`, `取る`, 2, `nimmt ／ nahm ／ genommen`, ``, 0, null, null],
    [655, `nein`, `いいえ`, 3, ``, ``, 0, null, null],
    [656, `neu`, `新しい`, 4, ``, ``, 0, null, null],
    [657, `nicht`, `〜ない`, 3, ``, ``, 0, null, null],
    [658, `nie`, `決して〜ない`, 3, ``, ``, 0, null, null],
    [659, `noch`, `まだ`, 3, ``, ``, 0, null, null],
    [660, `nochmal`, `もう一度`, 3, ``, ``, 5, null, null],
    [661, `normalerweise`, `ふつうなら`, 3, ``, ``, 2, null, null],
    ...
    [678, `der Onkel`, `おじ`, 1, `Onkels ／ Onkel`, ``, 3, null, null],
    ...
    [695, `die Pflicht`, `義務`, 1, `Pflicht ／ Pflichten`, ``, 2, null, null],
    [696, `die Philosophie`, `哲学`, 1, `Philosophie ／ Philosophien`, ``, 4, null, null],
    [697, `die Physik`, `物理学`, 1, `Physik ／ -`, ``, 3, null, null],
    [698, `die Pistole`, `ピストル`, 1, `Pistole ／ Pistolen`, ``, 4, null, null],
    [699, `der Plan`, `計画`, 1, `Plans ／ Pläne`, ``, 0, null, null],
    [700, `der Platz`, `場所、席、スペース`, 1, `Platzes ／ Plätze`, ``, 0, null, null],
    [701, `plaudern`, `おしゃべりをする`, 2, ``, ``, 5, null, null],
    [702, `die Politik`, `政治`, 1, `Politik ／ Politiken`, ``, 1, null, null],
    [703, `der Politiker`, `政治家`, 1, `Politikers ／ Politiker`, ``, 2, null, null],
    [704, `die Politikerin`, `政治家`, 1, `Politikerin ／ Politikerinnen`, ``, 2, null, null],
    ...
    [709, `die Post`, `郵便`, 1, `Post ／ -`, ``, 0, null, null],
    ...
    [761, `rufen`, `呼ぶ`, 2, `rief ／ gerufen`, ``, 2, null, null],
    ...
    [782, `schlafen`, `眠る`, 2, `schläft ／ schlief ／ geschlafen`, ``, 0, null, null],
    ...
    */
    [793, `schon`, `すでに`, 3, ``, ``, 0, null, null],
    [794, `schön`, `美しい`, 4, ``, ``, 0, null, null],
    /*
    [795, `schrecken`, `驚かす`, 2, `schrak ／ geschreckt`, ``, 4, null, null],
    [796, `schrecklich`, `恐ろしい`, 4, ``, ``, 2, null, null],
    [797, `schreiben`, `書く`, 2, `schrieb ／ geschrieben`, ``, 0, null, null],
    ...
    [801, `die Schule`, `学校`, 1, `Schule ／ Schulen`, ``, 0, null, null],
    [802, `der Schüler`, `生徒`, 1, `Schülers ／ Schüler`, ``, 0, null, null],
    [803, `die Schülerin`, `女生徒`, 1, `Schülerin ／ Schülerinnen`, ``, 0, null, null],
    ...
    */
    ...
    [814, `die Schwester`, `姉妹`, 1, `Schwester ／ Schwestern`, ``, 1, null, null],
    ...
    [820, `sehen`, `見える`, 2, `sieht ／ sah ／ gesehen`, ``, 0, null, null],
    [821, `sehr`, `とても`, 3, `mehr ／ am meisten`, ``, 0, null, null],
    ...
    [835, `singen`, `歌う`, 2, `sang ／ gesungen`, ``, 1, null, null],
    ...
    [839, `so`, `そのように`, 3, ``, ``, 0, null, null],
    [840, `sobald`, `…したらすぐに`, 6, ``, `従属接続詞`, 2, null, null],
    [841, `sofort`, `すぐに`, 3, ``, ``, 0, null, null],
    [842, `sogar`, `それどころか`, 3, ``, ``, 0, null, null],
    [843, `der Sohn`, `息子`, 1, `Sohnes ／ Söhne`, ``, 0, null, null],
    ...
    */
    ...
    [867, `sprechen`, `話す`, 2, `spricht ／ sprach ／ gesprochen`, ``, 0, null, null],
    ...
    [874, `stehen`, `立っている`, 2, `stand ／ gestanden`, ``, 0, null, null],
    [875, `stehlen`, `盗む`, 2, `stiehlt ／ stahl ／ gestohlen`, ``, 3, null, null],
    [876, `steigen`, `登る`, 2, `stieg ／ gestiegen`, ``, 2, null, null],
    [877, `stellen`, `立てる`, 2, ``, ``, 0, null, null],
    [878, `sterben`, `死ぬ`, 2, `stirbt ／ starb ／ gestorben`, ``, 1, null, null],
    ...
    [887, `der Student`, `大学生`, 1, `Studenten ／ Studenten`, ``, 0, null, null],
    [888, `die Studentin`, `女子大学生`, 1, `Studentin ／ Studentinnen`, ``, 0, null, null],
    [889, `studieren`, `大学で学ぶ`, 2, ``, ``, 1, null, null],
    */
    [890, `der Stuhl`, `椅子`, 1, `Stuhls ／ Stühle`, ``, 2, null, null],
    /*
    ...
    [895, `der Tag`, `１日、昼間`, 1, `Tages ／ Tage`, ``, 0, null, null],
    [896, `täglich`, `毎日の`, 4, ``, ``, 1, null, null],
    [897, `tagsüber`, `昼間`, 3, ``, ``, 4, null, null],
    [898, `der Taifun`, `台風`, 1, `Taifuns ／ Taifune`, ``, 5, null, null],
    [899, `die Tante`, `おば`, 1, `Tante ／ Tanten`, ``, 3, null, null],
    [900, `tanzen`, `踊る`, 2, ``, ``, 0, null, null],
    */
    ...
    [925, `tragen`, `運ぶ`, 2, `trägt ／ trug ／ getragen`, ``, 0, null, null],
    ...
    [963, `die Uni`, `大学[=Universität]`, 1, `Uni ／ Unis`, ``, 3, null, null],
    ...
    [979, `der Urlaubstag`, `休暇日`, 1, `Urlaubstags / -es ／ Urlaubstage`, ``, 5, null, null],
    [980, `die Ursache`, `原因`, 1, `Ursache ／ Ursachen`, ``, 2, null, null],
    [981, `die Vase`, `花瓶`, 1, `Vase ／ Vasen`, ``, 5, null, null],
    [982, `der Vater`, `父`, 1, `Vaters ／ Väter`, ``, 0, null, null],
    ...
    [991, `vergessen`, `忘れる`, 2, `vergisst ／ vergaß ／ vergessen`, ``, 0, null, null],
    [992, `vergessen`, `忘れる`, 2, `vergisst ／ vergaß ／ vergessen`, ``, 0, null, null],
    ...
    [1022, `der Vogel`, `鳥`, 1, `Vogels ／ Vögel`, ``, 1, null, null],
    ...
    [1037, `der Vorschlag`, `提案`, 1, `Vorschlags ／ Vorschläge`, ``, 2, null, null],
    ...
    [1049, `der Wald`, `森`, 1, `Waldes ／ Wälder`, ``, 1, null, null],
    ...
    [1089, `wo`, `どこに`, 3, ``, `疑問副詞`, 0, null, null],
    ...
    [1097, `wohnen`, `住んでいる`, 2, ``, ``, 0, null, null],
    ...
    [1114, `zeigen`, `見せる`, 2, ``, ``, 0, null, null],
    [1115, `zeihen`, `責める`, 2, `zieh ／ geeziehen`, ``, 5, null, null],
    [1116, `die Zeit`, `時、時間`, 1, `Zeit ／ Zeiten`, ``, 0, null, null],
    ...
    [1128, `der Zug`, `列車`, 1, `Zuges ／ Züge`, ``, 0, null, null],
